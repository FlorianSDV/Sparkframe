...
/**
 * Tests for SQLiteSelectQueryBuilder.
 */
class SQLiteSelectQueryBuilderTest extends TestCase
{
    ...
    {
        return new SqliteDatabaseWrapper(static::createStub(Sqlite::class))
    ...
    */
    ...
    public static function whereInDataProvider(): array
    {
        ...
        $sub_query_1_fn = function (): array {
            $sub_query_1 = new SqliteDatabaseWrapper(static::createStub(Sqlite::class))
        ...
        $sub_query_2_fn = function (): array {
            $sub_query_2 = new SqliteDatabaseWrapper(static::createStub(Sqlite::class))
    ...
    public function testWhereIn(array $where, callable $where_ins, string $expected_query, string $expected_query_with_values): void
    {
        ...
        foreach ($where_ins() as $where_in) {
            ...
            $this->sqlite_select_query_builder->whereIn(column_name: $column_name, values: $values);
        }
    ...
    public function testWhereNotIn(array $where, callable $where_not_ins, string $expected_query, string $expected_query_with_values): void
    {
        ...
        foreach ($where_not_ins() as $where_not_in) {
            ...
            $this->sqlite_select_query_builder->whereNotIn(column_name: $column_name, values: $values);
        }
    ...
    public function testOr(array $where, array $ors, callable $or_ins, callable $or_not_ins, string $expected_query, string $expected_query_with_values): void
    {
        ...
        foreach ($or_not_ins() as $or_not_in) {
            $this->sqlite_select_query_builder->orNotIn($or_not_in['column_name'], $or_not_in['values']);
        }
    ...
    {
        $sub_query_fn = fn (): SQLiteSelectQueryBuilder => new SqliteDatabaseWrapper(static::createStub(Sqlite::class))
            ->selectQuery('users', UserMockEntity::class)
            ->select(UserMockEntity::ID)
            ->where([UserMockEntity::AGE . ' > ' => 20]);
        return [
    ...
    public static function addWhereInDataProvider(): array
    {
        ...
        $where_in_subquery_fn = fn (): SQLiteSelectQueryBuilder => static::createSelectQueryBuilder('users', UserMockEntity::class)
                ->select(UserMockEntity::ID)
                ->where([UserMockEntity::AGE . ' > ' => 20]);
    ...
    {
        $get_query_fn = fn (): SQLiteSelectQueryBuilder => static::createSelectQueryBuilder('users', UserMockEntity::class);
        $get_ready_for_subquery_fn = fn (): SQLiteSelectQueryBuilder => $get_query_fn()->select(UserMockEntity::ID);
        $get_not_ready_for_subquery_fn = fn (): SQLiteSelectQueryBuilder => $get_query_fn()->select(UserMockEntity::ID, UserMockEntity::NAME);
    ...
    public function testAllOptions(): void
    {
        ...
        $sub_query_6 = static::createSelectQueryBuilder('notes', NoteMockEntity::class)
            ->select(NoteMockEntity::USER_ID)
            ->where([NoteMockEntity::TITLE . ' = ' => 'Movies']);
        ...
        $expected_sub_query_6_index = 26;
        $sub_query_6_index = $sub_query_6->getPreparedStatementIndex();
        $this->assertEquals($expected_sub_query_6_index, $sub_query_6_index);
    }
}
