...
/**
 * Tests for MySQLInsertQueryBuilder.
 */
class MySQLInsertQueryBuilderTest extends TestCase
{
    private MySQLInsertQueryBuilder $mysql_insert_query_builder;

    public function setUp(): void
    {
        $this->mysql_insert_query_builder = new MySQLDatabaseWrapper($this->createStub(Mysql::class))
    ...
    public function testInsertQuery(): void
    {
        ...
        $query = new ReflectionMethod(MySQLInsertQueryBuilder::class, 'getQuery')
            ->invoke($this->mysql_insert_query_builder, $columns);
    ...
    {
        $p_key_name = UserMockEntity::getPrimaryKeyColumnName();
        $base_query = new ReflectionMethod(MySQLInsertQueryBuilder::class, 'getQuery')
            ->invoke($this->mysql_insert_query_builder, UserMockEntity::getColumnNames());
    ...
    {
        $class_name = new ReflectionClass($this->mysql_insert_query_builder)
            ->getProperty('entity_class')
            ->getValue($this->mysql_insert_query_builder);
